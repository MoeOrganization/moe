...
This doc was AUTOGENERATED via the `syntax-examples` branch
...
## 006-packages
    ...
    # 006-packages/001.mo - contains invalid perl5 syntax
    package Foo {}

    # 006-packages/002.mo - contains invalid perl5 syntax
    package Foo::Bar {
    
        
    }
    # 006-packages/003.mo - contains invalid perl5 syntax
    package Foo {}
    package Bar::Baz {}
    package Baz::Gorch::Bling::BAM {}

    # 006-packages/004.mo - contains invalid perl5 syntax
    package Foo {
    ...
    # 006-packages/005.mo - contains invalid perl5 syntax
    package Bar {
    ...
    # 006-packages/006.mo - contains invalid perl5 syntax
    package Bar {
